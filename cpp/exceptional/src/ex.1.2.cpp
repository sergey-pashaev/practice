...
// Напишите класс ci_string, идентичный стандартному std::string, но
// который является нечувствительным к регистру символов в том же
// смысле, что и распространенное расширение библиотеки C++ stricmp().
