...
// Насколько практичен класс созданный в задаче ex.1.2 ci_string? В
// этой задаче мы обратимся к вопросам его использования. Мы узнаем, с
// какими проблемами можем столкнуться в процессе разработки, и
// заполним все оставшиеся пробелы в этой теме.
